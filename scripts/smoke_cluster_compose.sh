...
#       docker build -t auradb:0.8.0 .
#       AURADB_IMAGE=auradb:0.8.0 bash scripts/smoke_cluster_compose.sh
#   - Published image (post-release verification):
#       AURADB_IMAGE=ghcr.io/ohswedd/auradb:0.8.0 bash scripts/smoke_cluster_compose.sh
...
export AURADB_IMAGE="${AURADB_IMAGE:-ghcr.io/ohswedd/auradb:0.8.0}"
